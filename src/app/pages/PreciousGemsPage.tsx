...
export default function PreciousGemsPage() {
  ...
  useEffect(() => {
    const fetchGems = async () => {
      try {
        const gems = await api.getAllGems('Precious Gems');
        ...
        console.error('Error fetching precious gems:', error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <section className="bg-gradient-to-b from-[#faf9f7] to-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h1 className="font-display text-6xl md:text-7xl text-[#2d3748] mb-6 tracking-wide leading-tight">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          {loading ? (
            <div className="py-20 text-center">
              <p className="text-gray-600 font-body">Loading precious gemstones...</p>
            </div>
          ) : products.length === 0 ? (
            <div className="py-20 text-center">
              <p className="text-gray-600 font-body">No precious gemstones available at the moment.</p>
            </div>
          ) : (
